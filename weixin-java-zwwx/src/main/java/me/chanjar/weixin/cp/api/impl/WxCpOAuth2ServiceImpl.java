...
public class WxCpOAuth2ServiceImpl implements WxCpOAuth2Service {
  ...
  public WxCpOauth2UserInfo getUserInfo(String code) throws WxErrorException {
    return this.getUserInfo(this.mainService.getWxCpConfigStorage().getAccessToken(), code);
  }

  @Override
  public WxCpOauth2UserInfo getUserInfo(String accessToken, String code) throws WxErrorException {
    String responseText = this.mainService.get(String.format(this.mainService.getWxCpConfigStorage().getApiUrl(GET_USER_INFO), code, accessToken), null);
    ...
    return WxCpOauth2UserInfo.builder()
      ...
      .expiresIn(GsonHelper.getInteger(jo, "expires_in"))
      .userType(GsonHelper.getInteger(jo, "usertype"))
      .build();
  }
